...
import historyService from "../../services/oganations/historyService";
import ErrorState from "../../components/oganations/ErrorState";
...
export default function HistoryPage () {
  ...
  useEffect(()=> {
    ...
    const load = async () => {
      setIsLoading(true);
      try {
        const res = await historyService.getActivityHistory();
        if (res && res.success) {
          if (mounted) {
