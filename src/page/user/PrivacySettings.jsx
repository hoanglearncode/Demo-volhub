      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-slate-800">Cài đặt riêng tư</h1>
              <p className="text-slate-600 mt-1">Quản lý quyền riêng tư và bảo mật tài khoản của bạn</p>
            </div>
          </div>
        </div>
        ...
        <div className="grid lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-xl border border-gray-200 p-6 sticky top-28">
              <h2 className="font-semibold text-slate-800 mb-4">Danh mục</h2>
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-center gap-3">
                        ...
                        <ChevronRight size={16} className={`transition-transform ${isActive ? "rotate-90 text-blue-600" : "text-slate-400"}`} />
                      </div>
                    </button>
                  );
                })}
          ...
          <div className="lg:col-span-3">
            ...
            <div className="mt-8 flex justify-end">
              <button className="flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-blue-500 to-blue-600 text-white rounded-xl hover:from-blue-600 hover:to-blue-700 transition-all duration-200 shadow-lg hover:shadow-xl">
                <Check size={20} />
                Lưu thay đổi
              </button>
            </div>
